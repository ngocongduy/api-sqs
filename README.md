...
```bash
py36$ sam logs -n StockCheckerFunction --stack-name py36 --tail
```
...
```bash
py36$ pip install pytest pytest-mock --user
py36$ python -m pytest tests/ -v
```
...
```bash
aws cloudformation delete-stack --stack-name py36
```
